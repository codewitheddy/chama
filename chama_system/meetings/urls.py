...
urlpatterns = [
    ...
    path('<int:pk>/minutes/pdf/', views.MeetingMinutesPdfView.as_view(), name='minutes_pdf'),
    ...
    path('<int:pk>/penalty/apply-absent/', views.ApplyAbsentPenaltiesView.as_view(), name='apply_absent_penalties'),
